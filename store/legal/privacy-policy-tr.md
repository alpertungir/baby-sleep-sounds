...
Bebek Uyku Sesleri, bebeğinizin uykuya dalmasına yardımcı olmak için ses çalan bir mobil uygulamadır. Gizliliğinize saygı duyuyoruz ve kişisel veri toplamıyoruz.
...
Uygulama yalnızca aşağıdaki bilgileri **cihazınızda yerel olarak** saklar:
...
Uygulama ebeveynler ve bebek bakımı için tasarlanmıştır. Bilerek 13 yaş altı çocuklardan kişisel veri toplanmaz.
...
Kişisel veri toplanmadığı için erişim, düzeltme veya silme talebi gerektiren bir veri envanterimiz bulunmamaktadır. Favorileri uygulama içinden kaldırabilir veya uygulamayı silerek tüm yerel verileri temizleyebilirsiniz.

## Değişiklikler

Bu politika güncellenebilir. Önemli değişiklikler uygulama mağazası listesinde ve bu sayfada yayımlanır.
